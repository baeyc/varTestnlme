...
```{r}
vt <- varCompTest(m1diag.nlme,m0noRE,fim="compute",pval.comp = "both")
summary(vt)
vt2 <- varCompTest(m1diag.lme4,m0noRE,fim="compute",pval.comp = "both")
summary(vt2)
...
fm2Theo.nlme <- nlme(conc ~ SSfol(Dose, Time, lKe, lKa, lCl),
                     ...
                     start=c( -2.4, 0.45, -3.2),
                     random = pdDiag(lCl ~ 1))
varCompTest(fm1Theo.nlme,fm2Theo.nlme, pval.comp = "both")
