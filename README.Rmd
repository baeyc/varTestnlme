...
The package works on models that were fitted using [nlme](https://cran.r-project.org/web/packages/nlme/), [lme4](https://cran.r-project.org/web/packages/lme4/), or [saemix](https://cran.r-project.org/web/packages/saemix/) packages.
